        ...
        get_current_price = (error, response, body) ->
            ...
            get_account_balance = (error, response, body) ->
                ...
                forward_order = (error, response, body) ->
                    oandaErrors res, error, response, body
                    res.json body
                jsonParsingRequest.post options, forward_order

            jsonParsingRequest account_balance_request_options, get_account_balance

        jsonParsingRequest current_price_request_options, get_current_price
